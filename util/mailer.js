...
const sendMail=async(to)=>{
    ...
    const transporter=mailer.createTransport({
        ...
        secure:false,
        auth:{
            user:"meetp0878@gmail.com",
            pass:"zqgpassxvmqpqafe"
        }
    })
    const options={
        from:'meetp0878@gmail.com',
        to:to,
        subject:'varification-----gmail',
        html:`<!DOCTYPE html>
        ...
        <div align="center" class="alignment" style="line-height:10px"><a href="www.example.com" style="outline:none" tabindex="-1" target="_blank"><img alt="Your logo." src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/4036/5f4fa970-2c78-4218-9e89-9953d812ddb4.png" style="display: block; height: auto; border: 0; width: 160px; max-width: 100%;" title="Your logo." width="160"/></a></div>
        </td>
        </tr>
        </table>
        </td>
        ...
        <p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="font-size:30px;color:#2b303a;"><strong>OTP IS</strong></span></p>
        </div>
        </div>
        </td>
        </tr>
        ...
        <h1 style="margin: 0; color: #555555; font-size: 23px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><u><span class="tinyMce-placeholder">${temp}</span></u></h1>
        </td>
        </tr>
        </table>
        ...
        <p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;">VALID FOR 30 MINS ONLY</p>
        </div>
        </div>
        </td>
        </tr>
    ...
    transporter.sendMail(options,(err,info)=>{
        if(err){
            ...
            console.log(temp+" in mailer.js")
        }
    })
    return temp;
}
module.exports={sendMail}
// sendMail('meetpatel28803@gmail.com')